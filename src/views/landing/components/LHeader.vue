            ...
            <ul class="flex items-start justify-between">
                ...
                <li class="flex items-center gap-6">
                    <a href="tel:+998 71 200-05-22"
                        class="  hidden sm:flex items-center gap-1 sm:gap-[10px] font-semibold text-white text-xs sm:text-xl">
                        ...
                        <el-dropdown>
                            <button
                                ...
                                <svg width="13" height="7" viewBox="0 0 13 7" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1.71729 1L6.71729 6L11.7173 1" stroke="white" stroke-width="2"
                    ...
                    <router-link to="/login"
                        class="bg-blur text-[#EBEBEB] text-xs sm:text-base font-semibold flex items-center gap-2 p-[6px] sm:p-[10px] rounded-xl w-[114px]">
