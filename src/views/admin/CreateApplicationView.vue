<template>
  <div class="flex justify-between items-center mb-4">
    <el-button text @click="router.back()" class="text-primary">
      <Back class="h-4 w-4 text-blue-500" /><span class="text-blue-500 ml-2">Back</span>
    </el-button>
  </div>
  <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules" label-position="top" require-asterisk-position="right"
    ...
    <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-x-4 gap-y-2">
      <el-form-item :label="$t('dashboard.department')" prop="program_id" id="program_id">
        <el-select v-model="ruleForm.program_id" :placeholder="$t('dashboard.department')" filterable size="large"
          ...
          <el-option v-for="region of guideStore.getTuitions" class=" capitalize" :key="region.value"
            @click="langUpdate(region.lang, region.has_scholarship)" :label="$t(`${region.label}`)"
            :value="region.value" />
        </el-select>
      </el-form-item>
      ...
      <el-form-item label="E-mail Address" prop="email">
        <el-input v-model.trim="ruleForm.email" type="text" autocomplete="off" size="large"
    ...
    <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-x-4 gap-y-2">
      ...
      <el-form-item label="Password" prop="password">
        <el-input v-model.trim="ruleForm.password" type="text" autocomplete="off" size="large" />
      </el-form-item>
    ...
    <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-x-4 gap-y-2"
      ...
      <el-form-item :label="$t('dashboard.first_name')" prop="first_name" id="first_name">
        ...
        <el-input v-model="ruleForm.first_name" type="text" autocomplete="off" :placeholder="$t('dashboard.write_first')"
          size="large" />
      </el-form-item>
      ...
      <el-form-item :label="$t('dashboard.passport_seria')" prop="passport_serial" id="passport_serial">
